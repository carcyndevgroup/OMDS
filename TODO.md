...
- [x] Preview image attachments inline in the message reader.
...
- [x] Verify converted Lead threads, messages, participants, and attachments appear in Client Messages.
