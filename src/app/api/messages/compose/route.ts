...
type ComposePayload = { body?: unknown; clientId?: unknown; file?: File; leadId?: unknown; subject?: unknown; to?: unknown };
...
export async function POST(request: Request) {
  ...
  try {
    ...
    payload = { body: form.get("body"), clientId: form.get("clientId"), file: file instanceof File ? file : undefined, leadId: form.get("leadId"), subject: form.get("subject"), to: form.get("to") };
  } catch {
