// Canonical default contract template bodies sourced from other_files/contractdesign/*.html.
// Page 1 (cover) and page 4 (signatures) are rendered by the PDF shell.
// This body covers pages 2 (financial tables) and 3 (terms & conditions).

export const DIRECT_CONTRACT_DEFAULT_BODY = `
...
<ol>
  <li>The Client agrees to pay a retainer of forty percent (40%) of the Total Price (the "Retainer") immediately upon executing this Contract through the portal.</li>
...
<ol>
  ...
  <li>Two-Payment Track: The 40% Retainer is paid immediately upon booking, and a remaining 60% balance invoice is automatically generated by the portal, due no later than fifteen (15) days prior to the Event.</li>
...
<ol>
  ...
  <li>Cancellation &gt; 30 days before Event: Client forfeits the 40% Retainer only; any additional funds paid are refunded.</li>
...
export const PV_CONTRACT_DEFAULT_BODY = `
